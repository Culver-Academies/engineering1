...
Turn on the TurboPi robot (both switches) and wait until it beeps. TurboPi generates a WiFi starting with HW-. Connect your computer to this WiFi. The specific WiFi network is on the robot. Input the password **hiwonder**. After connecting, open the **Real VNC Viewer**. Input the IP address **192.168.149.1**, and then press **Enter**. 
