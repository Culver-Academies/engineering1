...
* Input the password **hiwonder**.
* After connecting, open the **Real VNC Viewer**.
* Input the IP address **192.168.149.1**, and then press **Enter**.
* Input the Username and Password. Username is **pi**  Password is **raspberry** then click OK. 
